...
entity design_1_v_frm_wr_0_0_FrmbufWrHlsDataFlow is
port (
...
architecture behav of design_1_v_frm_wr_0_0_FrmbufWrHlsDataFlow is 
...
attribute shreg_extract : string;
    ...
    signal AXIvideo2MultiPixStream_U0_img_din : STD_LOGIC_VECTOR (59 downto 0);
    signal AXIvideo2MultiPixStream_U0_img_write : STD_LOGIC;
    signal AXIvideo2MultiPixStream_U0_width_c_din : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal MultiPixStream2Bytes_U0_bytePlanes1_write : STD_LOGIC;
    ...
    signal Bytes2AXIMMvideo_U0_bytePlanes1_read : STD_LOGIC;
    ...
    signal img_dout : STD_LOGIC_VECTOR (59 downto 0);
    ...
    component design_1_v_frm_wr_0_0_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_AXIvideo2MultiPixStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_MultiPixStream2Bytes IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_Bytes2AXIMMvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_fifo_w32_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_fifo_w15_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_fifo_w16_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_fifo_w6_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_fifo_w60_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_fifo_w12_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_fifo_w128_d480_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_fifo_w15_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_start_for_MultiPixStream2Bytes_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frm_wr_0_0_start_for_Bytes2AXIMMvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component design_1_v_frm_wr_0_0_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AXIvideo2MultiPixStream_U0 : component design_1_v_frm_wr_0_0_AXIvideo2MultiPixStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    MultiPixStream2Bytes_U0 : component design_1_v_frm_wr_0_0_MultiPixStream2Bytes
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        bytePlanes1_din => MultiPixStream2Bytes_U0_bytePlanes1_din,
        ...
        bytePlanes1_write => MultiPixStream2Bytes_U0_bytePlanes1_write,
    ...
    Bytes2AXIMMvideo_U0 : component design_1_v_frm_wr_0_0_Bytes2AXIMMvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        bytePlanes1_read => Bytes2AXIMMvideo_U0_bytePlanes1_read,
    ...
    HwReg_frm_buffer_c_U : component design_1_v_frm_wr_0_0_fifo_w32_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    WidthInBytes_c9_U : component design_1_v_frm_wr_0_0_fifo_w15_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    stride_c_U : component design_1_v_frm_wr_0_0_fifo_w16_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    video_format_c_U : component design_1_v_frm_wr_0_0_fifo_w6_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    img_U : component design_1_v_frm_wr_0_0_fifo_w60_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    width_c_U : component design_1_v_frm_wr_0_0_fifo_w12_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_c10_U : component design_1_v_frm_wr_0_0_fifo_w12_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bytePlanes_plane0_U : component design_1_v_frm_wr_0_0_fifo_w128_d480_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => MultiPixStream2Bytes_U0_bytePlanes1_din,
        if_full_n => bytePlanes_plane0_full_n,
        if_write => MultiPixStream2Bytes_U0_bytePlanes1_write,
        ...
        if_read => Bytes2AXIMMvideo_U0_bytePlanes1_read);

    WidthInBytes_c_U : component design_1_v_frm_wr_0_0_fifo_w15_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_c_U : component design_1_v_frm_wr_0_0_fifo_w12_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2Bytes_U0_U : component design_1_v_frm_wr_0_0_start_for_MultiPixStream2Bytes_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Bytes2AXIMMvideo_U0_U : component design_1_v_frm_wr_0_0_start_for_Bytes2AXIMMvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
