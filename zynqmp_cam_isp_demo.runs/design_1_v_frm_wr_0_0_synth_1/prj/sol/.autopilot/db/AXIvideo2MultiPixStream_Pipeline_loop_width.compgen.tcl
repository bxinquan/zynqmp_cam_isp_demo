...
set id 19
set name design_1_v_frm_wr_0_0_mux_83_10_1_1
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video_TVALID { I 1 bit } s_axis_video_TDATA { I 64 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { axi_data_V_2 { I 60 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_icmp_ln235 \
    op interface \
    ports { icmp_ln235 { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_img \
    op interface \
    ports { img_din { O 60 vector } img_num_data_valid { I 2 vector } img_fifo_cap { I 2 vector } img_full_n { I 1 bit } img_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { axi_data_V_3_out { O 60 vector } axi_data_V_3_out_ap_vld { O 1 bit } } \
} "
}
