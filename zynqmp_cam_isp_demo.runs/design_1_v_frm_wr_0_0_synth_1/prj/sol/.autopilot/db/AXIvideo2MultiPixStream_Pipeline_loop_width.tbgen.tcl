...
set C_modelArgList {
	...
	{ axi_data_V_2 int 60 regular  }
	{ div_cast int 11 regular  }
	{ cond int 1 regular  }
	{ p_read2 int 3 regular  }
	{ icmp_ln235 int 1 regular  }
	...
	{ axi_data_V_3_out int 60 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sof_2", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_V_2", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "icmp_ln235", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_V_3_out", "interface" : "wire", "bitwidth" : 60, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ axi_data_V_2 sc_in sc_lv 60 signal 2 } 
	{ div_cast sc_in sc_lv 11 signal 3 } 
	{ cond sc_in sc_lv 1 signal 4 } 
	{ p_read2 sc_in sc_lv 3 signal 5 } 
	{ icmp_ln235 sc_in sc_lv 1 signal 6 } 
	...
	{ axi_data_V_3_out sc_out sc_lv 60 signal 16 } 
	{ axi_data_V_3_out_ap_vld sc_out sc_logic 1 outvld 16 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_V_2", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "axi_data_V_2", "role": "default" }} , 
 	...
 	{ "name": "icmp_ln235", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln235", "role": "default" }} , 
 	...
 	{ "name": "axi_data_V_3_out", "direction": "out", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "axi_data_V_3_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_83_10_1_1_U19", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	axi_data_V_2 { ap_none {  { axi_data_V_2 in_data 0 60 } } }
	div_cast { ap_none {  { div_cast in_data 0 11 } } }
	cond { ap_none {  { cond in_data 0 1 } } }
	p_read2 { ap_none {  { p_read2 in_data 0 3 } } }
	icmp_ln235 { ap_none {  { icmp_ln235 in_data 0 1 } } }
	...
	s_axis_video_V_data_V { axis {  { s_axis_video_TVALID in_vld 0 1 }  { s_axis_video_TDATA in_data 0 64 } } }
	...
	axi_data_V_3_out { ap_vld {  { axi_data_V_3_out out_data 1 60 }  { axi_data_V_3_out_ap_vld out_vld 1 1 } } }
}
