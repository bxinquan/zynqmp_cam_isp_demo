...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bytePlanes1_dout { I 128 vector } bytePlanes1_num_data_valid { I 10 vector } bytePlanes1_fifo_cap { I 10 vector } bytePlanes1_empty_n { I 1 bit } bytePlanes1_read { O 1 bit } } \
} "
}
