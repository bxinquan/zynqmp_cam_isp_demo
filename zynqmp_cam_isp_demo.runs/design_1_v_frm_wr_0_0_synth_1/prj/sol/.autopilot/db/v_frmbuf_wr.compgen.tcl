...
set name design_1_v_frm_wr_0_0_mul_12ns_3ns_15_1_1
...
set id 142
set name design_1_v_frm_wr_0_0_mul_mul_14ns_15ns_29_4_1
...
set ID 145
set hasByteEnable 0
set MemName design_1_v_frm_wr_0_0_BYTES_PER_PIXEL_ROM_AUTO_1R
...
set TrueReset 0
set IsROM 1
set ROMData { "000" "000" "000" "000" "000" "000" "000" "000" "000" "000" "100" "100" "010" "100" "100" "100" "100" "010" "001" "001" "011" "011" "100" "100" "001" "100" "100" "100" "010" "011" "101" "101" "011" "011" "011" "110" "110" "010" "010" "010" "000" "000" "001" "100" }
...
set ID 146
set hasByteEnable 0
set MemName design_1_v_frm_wr_0_0_MEMORY2LIVE_ROM_AUTO_1R
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 3
set AddrRange 44
...
set TrueReset 0
set IsROM 1
set ROMData { "000" "001" "010" "011" "000" "101" "110" "000" "000" "000" "000" "001" "010" "101" "110" "000" "001" "000" "010" "011" "000" "001" "010" "011" "001" "001" "101" "000" "010" "000" "000" "001" "010" "011" "001" "000" "001" "010" "011" "001" "000" "000" "001" "001" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set DelayBudget 0.677
...
set name design_1_v_frm_wr_0_0_mm_video_m_axi
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			...
			name design_1_v_frm_wr_0_0_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler design_1_v_frm_wr_0_0_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video_TDATA { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video_TKEEP { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video_TSTRB { I 8 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 156
set RegSliceName design_1_v_frm_wr_0_0_regslice_both
set RegSliceInstName design_1_v_frm_wr_0_0_regslice_both_U
set CoreName ap_simcore_design_1_v_frm_wr_0_0_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
