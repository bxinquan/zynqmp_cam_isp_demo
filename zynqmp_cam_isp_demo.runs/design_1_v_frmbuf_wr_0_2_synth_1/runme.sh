...
HD_PWD='D:/zynqmp_cam_isp_demo/zynqmp_cam_isp_demo.runs/design_1_v_frmbuf_wr_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_v_frmbuf_wr_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_v_frmbuf_wr_0_2.tcl
