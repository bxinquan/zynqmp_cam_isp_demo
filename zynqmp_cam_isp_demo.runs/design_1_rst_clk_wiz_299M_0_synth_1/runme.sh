...
HD_PWD='D:/zynqmp_cam_isp_demo/zynqmp_cam_isp_demo.runs/design_1_rst_clk_wiz_299M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_clk_wiz_299M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_clk_wiz_299M_0.tcl
