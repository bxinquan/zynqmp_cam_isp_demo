...
set name design_1_v_frmbuf_wr_0_0_urem_13ns_6ns_13_17_seq_1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WidthInPix_dout { I 13 vector } WidthInPix_num_data_valid { I 2 vector } WidthInPix_fifo_cap { I 2 vector } WidthInPix_empty_n { I 1 bit } WidthInPix_read { O 1 bit } } \
} "
}
