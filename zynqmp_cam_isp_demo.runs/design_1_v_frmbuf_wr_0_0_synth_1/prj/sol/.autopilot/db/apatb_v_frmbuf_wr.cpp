...
// tvout file define:
#define AUTOTB_TVOUT_PC_width "../tv/rtldatafile/rtl.design_1_v_frmbuf_wr_0_0_v_frmbuf_wr.autotvout_width.dat"
#define AUTOTB_TVOUT_PC_height "../tv/rtldatafile/rtl.design_1_v_frmbuf_wr_0_0_v_frmbuf_wr.autotvout_height.dat"
#define AUTOTB_TVOUT_PC_stride "../tv/rtldatafile/rtl.design_1_v_frmbuf_wr_0_0_v_frmbuf_wr.autotvout_stride.dat"
#define AUTOTB_TVOUT_PC_video_format "../tv/rtldatafile/rtl.design_1_v_frmbuf_wr_0_0_v_frmbuf_wr.autotvout_video_format.dat"
#define AUTOTB_TVOUT_PC_frm_buffer "../tv/rtldatafile/rtl.design_1_v_frmbuf_wr_0_0_v_frmbuf_wr.autotvout_frm_buffer.dat"
#define AUTOTB_TVOUT_PC_frm_buffer2 "../tv/rtldatafile/rtl.design_1_v_frmbuf_wr_0_0_v_frmbuf_wr.autotvout_frm_buffer2.dat"
#define AUTOTB_TVOUT_PC_frm_buffer3 "../tv/rtldatafile/rtl.design_1_v_frmbuf_wr_0_0_v_frmbuf_wr.autotvout_frm_buffer3.dat"
...
((hls::stream<__cosim_s15__>*)__xlx_apatb_param_s_axis_video_V_data_V)->read();
((hls::stream<short>*)__xlx_apatb_param_s_axis_video_V_keep_V)->read();
((hls::stream<short>*)__xlx_apatb_param_s_axis_video_V_strb_V)->read();
...
{
transaction<256> tr(6220800);
aesl_fh.read(AUTOTB_TVOUT_PC_mm_video, tr.p, tr.tbytes);
if (little_endian()) { tr.reorder(); }
tr.send<32>((char*)__xlx_apatb_param_frm_buffer, 2073600, 0);
tr.send<32>((char*)__xlx_apatb_param_frm_buffer2, 2073600, 2073600);
tr.send<32>((char*)__xlx_apatb_param_frm_buffer3, 2073600, 4147200);
}
#else
try {
static PostCheck<256> pc(AUTOTB_TVOUT_PC_mm_video);
pc.psize = 32;
...
// data
std::vector<__cosim_s15__> __xlx_apatb_param_s_axis_video_V_data_V_stream_buf;
{
  while (!((hls::stream<__cosim_s15__>*)__xlx_apatb_param_s_axis_video_V_data_V)->empty())
    __xlx_apatb_param_s_axis_video_V_data_V_stream_buf.push_back(((hls::stream<__cosim_s15__>*)__xlx_apatb_param_s_axis_video_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_video_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<__cosim_s15__>*)__xlx_apatb_param_s_axis_video_V_data_V)->write(__xlx_apatb_param_s_axis_video_V_data_V_stream_buf[i]);
  }
long __xlx_apatb_param_s_axis_video_stream_buf_size = ((hls::stream<__cosim_s15__>*)__xlx_apatb_param_s_axis_video_V_data_V)->size();
// keep
std::vector<short> __xlx_apatb_param_s_axis_video_V_keep_V_stream_buf;
{
  while (!((hls::stream<short>*)__xlx_apatb_param_s_axis_video_V_keep_V)->empty())
    __xlx_apatb_param_s_axis_video_V_keep_V_stream_buf.push_back(((hls::stream<short>*)__xlx_apatb_param_s_axis_video_V_keep_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_video_V_keep_V_stream_buf.size(); ++i)
    ((hls::stream<short>*)__xlx_apatb_param_s_axis_video_V_keep_V)->write(__xlx_apatb_param_s_axis_video_V_keep_V_stream_buf[i]);
  }
// strb
std::vector<short> __xlx_apatb_param_s_axis_video_V_strb_V_stream_buf;
{
  while (!((hls::stream<short>*)__xlx_apatb_param_s_axis_video_V_strb_V)->empty())
    __xlx_apatb_param_s_axis_video_V_strb_V_stream_buf.push_back(((hls::stream<short>*)__xlx_apatb_param_s_axis_video_V_strb_V)->read());
  for (int i = 0; i < __xlx_apatb_param_s_axis_video_V_strb_V_stream_buf.size(); ++i)
    ((hls::stream<short>*)__xlx_apatb_param_s_axis_video_V_strb_V)->write(__xlx_apatb_param_s_axis_video_V_strb_V_stream_buf[i]);
  }
// user
...
if (__xlx_apatb_param_frm_buffer) {
  tr.import<32>((char*)__xlx_apatb_param_frm_buffer, 2073600, 0);
}
__xlx_offset_byte_param_frm_buffer2 = 2073600*32;
if (__xlx_apatb_param_frm_buffer2) {
  tr.import<32>((char*)__xlx_apatb_param_frm_buffer2, 2073600, 0);
}
__xlx_offset_byte_param_frm_buffer3 = 4147200*32;
if (__xlx_apatb_param_frm_buffer3) {
  tr.import<32>((char*)__xlx_apatb_param_frm_buffer3, 2073600, 0);
}
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_frm_buffer + i * 32;
...
if (__xlx_apatb_param_frm_buffer2) {
for (size_t i = 0; i < 2073600; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_frm_buffer2 + i * 32;
std::string s = formatData(pos, 256);
aesl_fh.write(AUTOTB_TVIN_mm_video, s);
}
}
...
if (__xlx_apatb_param_frm_buffer3) {
for (size_t i = 0; i < 2073600; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_frm_buffer3 + i * 32;
std::string s = formatData(pos, 256);
aesl_fh.write(AUTOTB_TVIN_mm_video, s);
}
}
...
long __xlx_apatb_param_s_axis_video_stream_buf_final_size = __xlx_apatb_param_s_axis_video_stream_buf_size - ((hls::stream<__cosim_s15__>*)__xlx_apatb_param_s_axis_video_V_data_V)->size();
...
for (int i = 0; i < __xlx_apatb_param_s_axis_video_stream_buf_final_size; ++i) {
  std::string s;
s = formatData((unsigned char*)(__xlx_apatb_param_s_axis_video_V_data_V_stream_buf.data()+i), 120);
aesl_fh.write(AUTOTB_TVIN_s_axis_video_V_data_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_s_axis_video_V_keep_V_stream_buf.data()+i), 15);
aesl_fh.write(AUTOTB_TVIN_s_axis_video_V_keep_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_s_axis_video_V_strb_V_stream_buf.data()+i), 15);
