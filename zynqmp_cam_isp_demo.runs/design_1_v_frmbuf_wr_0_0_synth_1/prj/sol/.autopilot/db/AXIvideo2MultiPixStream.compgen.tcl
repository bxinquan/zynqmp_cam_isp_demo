...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_img \
    op interface \
    ports { img_din { O 120 vector } img_num_data_valid { I 2 vector } img_fifo_cap { I 2 vector } img_full_n { I 1 bit } img_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_width_c \
    op interface \
    ports { width_c_din { O 13 vector } width_c_num_data_valid { I 2 vector } width_c_fifo_cap { I 2 vector } width_c_full_n { I 1 bit } width_c_write { O 1 bit } } \
} "
}
