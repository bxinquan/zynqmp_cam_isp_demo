...
set C_modelArgList {
	...
	{ axi_data_V_3_out int 120 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sof_2", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_V_2", "interface" : "wire", "bitwidth" : 120, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_V_3_out", "interface" : "wire", "bitwidth" : 120, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ img_din sc_out sc_lv 120 signal 6 } 
	{ img_num_data_valid sc_in sc_lv 2 signal 6 } 
	{ img_fifo_cap sc_in sc_lv 2 signal 6 } 
	{ img_full_n sc_in sc_logic 1 signal 6 } 
	{ img_write sc_out sc_logic 1 signal 6 } 
	{ sof_2 sc_in sc_lv 1 signal 0 } 
	{ axi_last_V_2 sc_in sc_lv 1 signal 1 } 
	{ axi_data_V_2 sc_in sc_lv 120 signal 2 } 
	{ div_cast sc_in sc_lv 11 signal 3 } 
	{ cond sc_in sc_lv 1 signal 4 } 
	{ icmp_ln235 sc_in sc_lv 1 signal 5 } 
	{ s_axis_video_TDATA sc_in sc_lv 120 signal 7 } 
	{ s_axis_video_TREADY sc_out sc_logic 1 inacc 13 } 
	{ s_axis_video_TKEEP sc_in sc_lv 15 signal 8 } 
	{ s_axis_video_TSTRB sc_in sc_lv 15 signal 9 } 
	...
	{ axi_data_V_3_out sc_out sc_lv 120 signal 15 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_V_2", "direction": "in", "datatype": "sc_lv", "bitwidth":120, "type": "signal", "bundle":{"name": "axi_data_V_2", "role": "default" }} , 
 	...
 	{ "name": "axi_data_V_3_out", "direction": "out", "datatype": "sc_lv", "bitwidth":120, "type": "signal", "bundle":{"name": "axi_data_V_3_out", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "1054"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "1054"}
]}
...
set Spec2ImplPortList { 
	...
	axi_data_V_2 { ap_none {  { axi_data_V_2 in_data 0 120 } } }
	...
	axi_data_V_3_out { ap_vld {  { axi_data_V_3_out out_data 1 120 }  { axi_data_V_3_out_ap_vld out_vld 1 1 } } }
}
