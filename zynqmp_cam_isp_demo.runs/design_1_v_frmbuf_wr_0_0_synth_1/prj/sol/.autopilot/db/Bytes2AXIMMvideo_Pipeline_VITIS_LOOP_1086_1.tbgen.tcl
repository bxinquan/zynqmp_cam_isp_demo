...
set C_modelArgMapList {[ 
	{ "Name" : "mm_video", "interface" : "axi_master", "bitwidth" : 256, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "frm_buffer","offset": { "type": "dynamic","port_name": "frm_buffer","bundle": "CTRL"},"direction": "WRITEONLY"},{"cName": "frm_buffer2","offset": { "type": "dynamic","port_name": "frm_buffer2","bundle": "CTRL"},},{"cName": "frm_buffer3","offset": { "type": "dynamic","port_name": "frm_buffer3","bundle": "CTRL"},}]}]} , 
 	{ "Name" : "sext_ln1086", "interface" : "wire", "bitwidth" : 27, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ bytePlanes1_dout sc_in sc_lv 256 signal 3 } 
	{ bytePlanes1_num_data_valid sc_in sc_lv 10 signal 3 } 
	{ bytePlanes1_fifo_cap sc_in sc_lv 10 signal 3 } 
	{ bytePlanes1_empty_n sc_in sc_logic 1 signal 3 } 
	{ bytePlanes1_read sc_out sc_logic 1 signal 3 } 
	...
	{ sext_ln1086 sc_in sc_lv 27 signal 1 } 
	{ loopWidth sc_in sc_lv 11 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln1086", "direction": "in", "datatype": "sc_lv", "bitwidth":27, "type": "signal", "bundle":{"name": "sext_ln1086", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln1086 { ap_none {  { sext_ln1086 in_data 0 27 } } }
