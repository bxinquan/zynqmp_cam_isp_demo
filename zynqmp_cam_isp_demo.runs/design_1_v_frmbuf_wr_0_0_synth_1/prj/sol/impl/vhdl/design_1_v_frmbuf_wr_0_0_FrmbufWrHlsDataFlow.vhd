...
attribute shreg_extract : string;
    ...
    signal AXIvideo2MultiPixStream_U0_width_c_din : STD_LOGIC_VECTOR (12 downto 0);
    ...
    component design_1_v_frmbuf_wr_0_0_fifo_w120_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_wr_0_0_fifo_w13_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component design_1_v_frmbuf_wr_0_0_fifo_w256_d264_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    img_U : component design_1_v_frmbuf_wr_0_0_fifo_w120_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    width_c_U : component design_1_v_frmbuf_wr_0_0_fifo_w13_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bytePlanes_plane0_U : component design_1_v_frmbuf_wr_0_0_fifo_w256_d264_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
