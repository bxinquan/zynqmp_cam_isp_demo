...
(* CORE_GENERATION_INFO = "bd_a878,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_a878,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=40,numReposBlks=32,numNonXlnxBlks=0,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "design_1_axi_smc_1_0.hwdef" *) 
module bd_a878
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
