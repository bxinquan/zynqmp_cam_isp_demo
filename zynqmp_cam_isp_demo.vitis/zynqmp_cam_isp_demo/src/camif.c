...
#define MIPI_RX_BASE     	XPAR_CAMIF_IAS1_MIPI_RX_TO_VIDEO_S00_AXI_BASEADDR
#define VFRM_WR_DEVID    	XPAR_CAMIF_IAS1_V_FRM_WR_DEVICE_ID
#define MIPI_RX_IRQ_INTR 	XPAR_AXI_INTC_CAMIF_IAS1_MIPI_RX_TO_VIDEO_IRQ_INTR
#define VFRM_WR_IRQ_INTR 	XPAR_AXI_INTC_CAMIF_IAS1_V_FRM_WR_INTERRUPT_INTR
#endif
#if SNS_TYPE == SNS_TYPE_OV5647
#define MIPI_RX_BASE     	XPAR_CAMIF_RPI_MIPI_RX_TO_VIDEO_S00_AXI_BASEADDR
#define VFRM_WR_DEVID    	XPAR_CAMIF_RPI_V_FRM_WR_DEVICE_ID
#define MIPI_RX_IRQ_INTR 	XPAR_AXI_INTC_CAMIF_RPI_MIPI_RX_TO_VIDEO_IRQ_INTR
#define VFRM_WR_IRQ_INTR 	XPAR_AXI_INTC_CAMIF_RPI_V_FRM_WR_INTERRUPT_INTR
#endif
