...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = camif_ias1_mipi_rx_to_video_ias1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mipi_rx_to_video
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = camif_rpi_mipi_rx_to_video_rpi
END
...
BEGIN DRIVER
 ...
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = isp_pipe_vip
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = camif_ias1_vfrm_wr_ias1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_wr
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = camif_rpi_vfrm_wr_rpi
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_rd
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = isp_pipe_vfrm_rd_isp
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_wr
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = isp_pipe_vfrm_wr_isp
END
