...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = xil_isp_lite
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = isp_pipe_isp
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = mipi_rx_to_video
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = camif_ias1_mipi_rx_to_video
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_wr
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = camif_ias1_v_frm_wr
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mipi_rx_to_video
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = camif_rpi_mipi_rx_to_video
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_wr
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = camif_rpi_v_frm_wr
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.9
 PARAMETER HW_INSTANCE = gpio_slice_axi_gpio
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_rd
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = isp_pipe_v_frm_rd
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_wr
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = isp_pipe_v_frm_wr_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_frmbuf_wr
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = isp_pipe_v_frm_wr_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = xil_vip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = isp_pipe_vip_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = xil_vip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = isp_pipe_vip_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 3.1
 PARAMETER HW_INSTANCE = vcu
END
