...
--               d:/zynqmp_cam_isp_demo/zynqmp_cam_isp_demo.gen/sources_1/bd/design_1/ip/design_1_video_to_axis_0_0/design_1_video_to_axis_0_0_sim_netlist.vhdl
...
entity design_1_video_to_axis_0_0_full_dp_ram is
  port (
    ...
    mem_reg_bram_1_0 : in STD_LOGIC_VECTOR ( 10 downto 0 );
    \raddr_reg__0\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    vid_clk : in STD_LOGIC;
    aclk : in STD_LOGIC;
    wdata_a : in STD_LOGIC_VECTOR ( 40 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_video_to_axis_0_0_full_dp_ram : entity is "full_dp_ram";
end design_1_video_to_axis_0_0_full_dp_ram;

architecture STRUCTURE of design_1_video_to_axis_0_0_full_dp_ram is
  ...
  signal p_0_out : STD_LOGIC_VECTOR ( 40 to 40 );
  ...
  attribute RTL_RAM_BITS of mem_reg_bram_0 : label is 43008;
  ...
  attribute RTL_RAM_BITS of mem_reg_bram_1 : label is 43008;
  ...
  attribute ram_slice_end of mem_reg_bram_1 : label is 41;
begin
...
mem_reg_bram_1: unisim.vcomponents.RAMB18E2
    generic map(
      ...
      WRITE_WIDTH_B => 18
        ...
        port map (
      ADDRARDADDR(13 downto 4) => waddr_reg(9 downto 0),
      ...
      DINADIN(5) => wdata_a(40),
      DINADIN(4) => p_0_out(40),
      DINADIN(3 downto 0) => wdata_a(39 downto 36),
      ...
      DOUTBDOUT(5 downto 0) => q_b(41 downto 36),
...
mem_reg_bram_1_i_10: unisim.vcomponents.LUT3
    generic map(
      INIT => X"69"
    )
        port map (
      I0 => raddr_reg(3),
      I1 => raddr_reg(4),
      I2 => mem_reg_bram_1_0(3),
      O => mem_reg_bram_1_i_10_n_0
    );
mem_reg_bram_1_i_11: unisim.vcomponents.LUT5
    generic map(
      INIT => X"06609009"
    )
        port map (
      I0 => mem_reg_bram_1_0(7),
      I1 => raddr_reg(7),
      I2 => mem_reg_bram_1_0(8),
      I3 => raddr_reg(9),
      I4 => raddr_reg(8),
...
mem_reg_bram_1_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9FF6"
        ...
        port map (
      I0 => mem_reg_bram_1_0(9),
      I1 => raddr_reg(9),
      I2 => mem_reg_bram_1_0(10),
      I3 => \raddr_reg__0\(0),
      O => \^w2r_wptr2_reg[9]\
    );
mem_reg_bram_1_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"D77DFFFFFFFFFFFF"
        ...
        port map (
      I0 => mem_reg_bram_1_i_8_n_0,
      I1 => raddr_reg(0),
      I2 => raddr_reg(1),
      I3 => mem_reg_bram_1_0(0),
      I4 => mem_reg_bram_1_i_9_n_0,
      I5 => mem_reg_bram_1_i_10_n_0,
      O => raddr_reg_0_sn_1
    );
mem_reg_bram_1_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6900"
        ...
        port map (
      I0 => mem_reg_bram_1_0(6),
      I1 => raddr_reg(7),
      I2 => raddr_reg(6),
      I3 => mem_reg_bram_1_i_11_n_0,
      O => \^w2r_wptr2_reg[6]\
    );
...
mem_reg_bram_1_i_8: unisim.vcomponents.LUT5
    generic map(
      INIT => X"06609009"
        ...
        port map (
      I0 => mem_reg_bram_1_0(1),
      I1 => raddr_reg(1),
      I2 => mem_reg_bram_1_0(2),
      I3 => raddr_reg(3),
      I4 => raddr_reg(2),
...
mem_reg_bram_1_i_9: unisim.vcomponents.LUT5
    generic map(
      INIT => X"06609009"
        ...
        port map (
      I0 => mem_reg_bram_1_0(4),
      I1 => raddr_reg(4),
      I2 => mem_reg_bram_1_0(5),
      I3 => raddr_reg(6),
      I4 => raddr_reg(5),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_video_to_axis_0_0_async_fifo is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_video_to_axis_0_0_async_fifo : entity is "async_fifo";
end design_1_video_to_axis_0_0_async_fifo;

architecture STRUCTURE of design_1_video_to_axis_0_0_async_fifo is
...
ram: entity work.design_1_video_to_axis_0_0_full_dp_ram
     port map (
      Q(10 downto 0) => r2w_rptr2(10 downto 0),
      aclk => aclk,
      m_axis_tready => m_axis_tready,
      m_axis_tvalid => m_axis_tvalid,
      mem_reg_bram_1_0(10 downto 0) => w2r_wptr2(10 downto 0),
      prev_active_video => prev_active_video,
      q_b(41 downto 0) => q_b(41 downto 0),
      \r2w_rptr2_reg[0]\ => ram_n_2,
      ...
      vid_ce => vid_ce,
      vid_clk => vid_clk,
      \w2r_wptr2_reg[6]\ => ram_n_7,
      \w2r_wptr2_reg[9]\ => ram_n_5,
      waddr_reg(9 downto 0) => waddr_reg(9 downto 0),
      waddr_reg_7_sp_1 => ram_n_3,
      waddr_reg_9_sp_1 => ram_n_1,
      \waddr_reg__0\(0) => \waddr_reg__0\(10),
      wdata_a(40 downto 0) => wdata_a(40 downto 0),
      wr_flag => wr_flag
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_video_to_axis_0_0_video_to_axis is
  port (
    q_b : out STD_LOGIC_VECTOR ( 41 downto 0 );
    overflow : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_video_to_axis_0_0_video_to_axis : entity is "video_to_axis";
end design_1_video_to_axis_0_0_video_to_axis;

architecture STRUCTURE of design_1_video_to_axis_0_0_video_to_axis is
  ...
  signal prev_data : STD_LOGIC_VECTOR ( 39 downto 0 );
  signal prev_vsync : STD_LOGIC;
begin
  m_axis_tvalid <= \^m_axis_tvalid\;
fifo: entity work.design_1_video_to_axis_0_0_async_fifo
     port map (
      aclk => aclk,
      aresetn => aresetn,
      aresetn_0 => fifo_n_0,
      ...
      vid_rstn => vid_rstn,
      vid_rstn_0 => fifo_n_1,
      wdata_a(40) => frmsync_reg_n_0,
      wdata_a(39 downto 0) => prev_data(39 downto 0)
    );
...
\prev_data_reg[24]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[25]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[26]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[27]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[28]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[29]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[30]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[31]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[32]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[33]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[34]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[35]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[36]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[37]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[38]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
\prev_data_reg[39]\: unisim.vcomponents.FDCE
     port map (
      C => vid_clk,
      CE => vid_ce,
      CLR => fifo_n_1,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_video_to_axis_0_0_video_to_axis_v1_0 is
  port (
    q_b : out STD_LOGIC_VECTOR ( 41 downto 0 );
    overflow : out STD_LOGIC;
    m_axis_tvalid : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_video_to_axis_0_0_video_to_axis_v1_0 : entity is "video_to_axis_v1_0";
end design_1_video_to_axis_0_0_video_to_axis_v1_0;

architecture STRUCTURE of design_1_video_to_axis_0_0_video_to_axis_v1_0 is
begin
video_to_axis_inst: entity work.design_1_video_to_axis_0_0_video_to_axis
     port map (
      aclk => aclk,
      aresetn => aresetn,
      m_axis_tready => m_axis_tready,
...
entity design_1_video_to_axis_0_0 is
  ...
  attribute NotValidForBitStream of design_1_video_to_axis_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_video_to_axis_0_0 : entity is "design_1_video_to_axis_0_0,video_to_axis_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_video_to_axis_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_video_to_axis_0_0 : entity is "video_to_axis_v1_0,Vivado 2022.1";
end design_1_video_to_axis_0_0;

architecture STRUCTURE of design_1_video_to_axis_0_0 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of aclk : signal is "xilinx.com:signal:clock:1.0 aclk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME aclk, ASSOCIATED_RESET aresetn, ASSOCIATED_BUSIF m_axis, FREQ_HZ 150074602, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_clk_wiz_0_0_clk_sys, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of aresetn : signal is "xilinx.com:signal:reset:1.0 aresetn RST";
  attribute X_INTERFACE_PARAMETER of aresetn : signal is "XIL_INTERFACENAME aresetn, POLARITY ACTIVE_LOW, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of m_axis_tlast : signal is "xilinx.com:interface:axis:1.0 m_axis TLAST";
  attribute X_INTERFACE_INFO of m_axis_tready : signal is "xilinx.com:interface:axis:1.0 m_axis TREADY";
  attribute X_INTERFACE_INFO of m_axis_tuser : signal is "xilinx.com:interface:axis:1.0 m_axis TUSER";
  attribute X_INTERFACE_PARAMETER of m_axis_tuser : signal is "XIL_INTERFACENAME m_axis, TDATA_NUM_BYTES 5, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 1, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 150074602, PHASE 0.0, CLK_DOMAIN design_1_clk_wiz_0_0_clk_sys, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of vid_clk : signal is "XIL_INTERFACENAME vid_clk, ASSOCIATED_RESET vid_rstn:vid_ce, ASSOCIATED_BUSIF vid_in, ASSOCIATED_CLKEN vid_ce, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_mipi_rx_to_video_0_0_vid_clk, INSERT_VIP 0";
...
begin
inst: entity work.design_1_video_to_axis_0_0_video_to_axis_v1_0
     port map (
      aclk => aclk,
      aresetn => aresetn,
      m_axis_tready => m_axis_tready,
      ...
      q_b(41) => m_axis_tuser,
      q_b(40) => m_axis_tlast,
      q_b(39 downto 0) => m_axis_tdata(39 downto 0),
      vid_active_video => vid_active_video,
      vid_ce => vid_ce,
      vid_clk => vid_clk,
      vid_data(39 downto 0) => vid_data(39 downto 0),
